...
def main():
    parser=argparse.ArgumentParser(description='A dependency-light QLoRA reference demonstrating 4-bit loading, frozen weights, low-rank adapters, merge, and held-out evaluation.')
