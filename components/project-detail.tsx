...
export function ProjectDetail({ project }: { project: Project }) {
  ...
  return <main className="app-shell"><Header active="projects"/><div className="detail-wrap">
    ...
    <nav className="detail-nav"><a href="#overview">Overview</a><a href="#guided-solution">Guided solution</a><Link href={`/projects/${project.slug}/article`}>First-principles article</Link><Link href={`/projects/${project.slug}/architecture`}>Architecture</Link><a href="#progress">Progress</a></nav>
