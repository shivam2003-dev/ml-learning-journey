...
export function ThemeToggle() {
  ...
  useEffect(() => { const saved = localStorage.getItem("ml-walkthrough-theme") as Theme | null; const next = saved ?? "anthropic"; setTheme(next); document.documentElement.dataset.learningTheme = next; }, []);
  ...
  return <div className="walk-theme" aria-label="Walkthrough theme">
